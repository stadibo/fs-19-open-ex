...
const CreateNew = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    props.notify(`Added new anecdote: ${content}`)
    ...
    <div>
      <Router>
        <div>
          ...
          <Route path="/" render={() => <Notification message={notification} />} />
          <Route exact path="/" render={() => <AnecdoteList anecdotes={anecdotes} />} />
          <Route exact path="/create" render={() => <CreateNewWithHistory addNew={addNew} notify={notify} />} />
